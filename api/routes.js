...
app.get("/html/recently_played", (req, res) => {
	res.sendFile(path.join(__dirname, "../src/html/recently_played.html"));
});
...
app.get("/html/top_items", (req, res) => {
	res.sendFile(path.join(__dirname, "../src/html/top_items.html"));
});

app.get("/html/email_verified", (req, res) => {
	res.sendFile(path.join(__dirname, "../src/html/email_verified.html"));
});
...
app.post(
	...
	async (req, res) => {
		try {
			...
			const htmlPath = path.join(__dirname, "../src/html/verification_email.html");
